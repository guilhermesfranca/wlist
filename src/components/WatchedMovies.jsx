    ...
    <div className="container mx-auto px-6 py-10">
      {filmes.length > 0 ? (
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-sm font-medium transition bg-green-100 text-green-700 border border-green-300 hover:bg-green-200"
                  >
                    <span>✓</span>
                    Assistido
                  </button>
        ...
        <div className="flex justify-center items-center min-h-[400px]">
          <p className="text-lg text-gray-600">Nenhum filme assistido ainda.</p>
        </div>
      )}
    </div>
  );
